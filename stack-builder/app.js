...
function getEmbedCode() {
  ...
  return `<iframe src="${url.toString()}" width="100%" height="700" frameborder="0" style="border-radius:12px;border:1px solid #2a2a2a;" title="Nootropic Stack Builder — Powered by Cognitive Edge"></iframe>`;
}
